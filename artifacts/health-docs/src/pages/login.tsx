      ...
      <div className="hidden md:flex md:w-1/2 lg:w-[60%] bg-primary/5 flex-col justify-center items-center p-12 relative overflow-hidden">
        ...
        <div className="max-w-xl z-10 text-center space-y-6">
          <div className="flex items-center justify-center gap-3 text-primary mb-8">
            ...
            <h1 className="text-5xl font-bold tracking-tight">وثائقي الصحي</h1>
          </div>
          <p className="text-2xl text-muted-foreground/80 font-medium">{t('auth.system_title')}</p>
          <div className="grid grid-cols-2 gap-4 pt-12">
            <div className="bg-background/60 p-6 rounded-2xl border backdrop-blur-sm">
              <h3 className="font-semibold text-lg mb-2">امتثال فوري</h3>
              <p className="text-sm text-muted-foreground">تتبع صلاحية الوثائق والتراخيص بشكل لحظي عبر المنشأة</p>
            </div>
            <div className="bg-background/60 p-6 rounded-2xl border backdrop-blur-sm">
              <h3 className="font-semibold text-lg mb-2">قراءة ذكية</h3>
              <p className="text-sm text-muted-foreground">استخراج البيانات تلقائياً من الوثائق عبر تقنية OCR</p>
            </div>
            <div className="bg-background/60 p-6 rounded-2xl border backdrop-blur-sm">
              <h3 className="font-semibold text-lg mb-2">توثيق QR</h3>
              <p className="text-sm text-muted-foreground">تحقق سريع وآمن من صحة الوثائق عبر مسح الرمز</p>
            </div>
            <div className="bg-background/60 p-6 rounded-2xl border backdrop-blur-sm">
              <h3 className="font-semibold text-lg mb-2">تنبيهات استباقية</h3>
              <p className="text-sm text-muted-foreground">إشعارات مبكرة قبل انتهاء صلاحية الوثائق الهامة</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col justify-center px-4 py-8 sm:px-8 md:w-1/2 md:px-12 md:py-12 lg:w-[40%] lg:px-16">
        <div className="mx-auto w-full max-w-md space-y-7 sm:space-y-8">
          ...
          <div className="pt-8 border-t space-y-4">
            <p className="text-sm text-muted-foreground text-center font-medium">{t('auth.demo_accounts')}</p>
