...
4. Verify JWT constraints, strong production secrets, cookie/CSRF/CORS behavior, sensitive-log redaction, reset-token handling, and secure mobile token storage.
